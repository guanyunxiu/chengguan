...
import com.swsdkj.wsl.activity.ImageSingActivity;
import com.swsdkj.wsl.activity.MyVideoView;
import com.swsdkj.wsl.activity.PlayVideo;
import com.swsdkj.wsl.activity.VideoSurface;
...
public class SignYesAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{

    private Context context;
    private List<SignBean> signBeanList;
    public SignYesAdapter(Context context, List<SignBean> signBeanList){
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View layout = LayoutInflater.from(context).inflate(R.layout.item_signyes, parent, false);
            ...
            if (signBean!=null){
                ...
                if (!TextUtils.isEmpty(signBean.getPhoto1())){
                    ...
                    if (str1.equals("mp4")){
                        ...
                        Picasso.with(context)
                                .load(BaseUrl.UMAGE_URL + signBean.getPhoto1()).fit()
                                .into(((MyHolder) holder).imageView1);
                    }
                    //视频播放
